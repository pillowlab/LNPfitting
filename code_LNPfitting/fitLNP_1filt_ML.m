function [gg,neglogli,postCov,H] = fitLNP_1filt_ML(gg,Stim,sps,optimArgs)
% FITLNP_1FILT_ML - fit LNP filter and dc term by ML under given nonlinearity
%
% [gg,neglogli,postCov,H] = fitLNP_1filt_ML(gg,Stim,sps,optimArgs)
% 
...
if nargout > 2 
    ...
    [ntkbas,nxkbas] = size(gg.ktbas);
    Q = mat2cell(repmat(gg.ktbas,1,nxk),ntkbas,nxkbas*ones(1,nxk));
    B = blkdiag(Q{:}); 
